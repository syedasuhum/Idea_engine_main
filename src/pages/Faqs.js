const faqData = [
  {
    question: "What is Idea Engine?",
    answer:
      "Idea Engine is an innovative platform that transforms your ideas and visions into actionable plans. It helps individuals, startups, and companies convert their thoughts into comprehensive blueprints for projects, ranging from website development and marketing campaigns to product roadmaps and business strategies.",
  },
  {
    question: "How does Idea Engine help with project planning and execution?",
    answer:
      "Idea Engine simplifies project planning and execution by generating detailed blueprints tailored to your specific requirements. Our intelligent system guides you through a conversational interface, asking relevant questions to capture all the necessary information. In just a few minutes, you'll have a comprehensive plan of action that outlines the scope, deliverables, and strategies for your project.",
  },
  {
    question: "Who can benefit from using Idea Engine?",
    answer:
      "Idea Engine is designed to benefit anyone with a project or idea, regardless of their level of expertise. Whether you're an entrepreneur, a marketing professional, a product manager, or a business owner, DayZero empowers you to create well-defined blueprints, even if you don't have the time or knowledge to do it yourself.",
  },
  {
    question: "How does Idea Engine generate blueprints?",
    answer:
      "Idea Engine utilizes advanced algorithms and industry best practices to generate blueprints. By analyzing the information you provide and leveraging our extensive knowledge base, Idea Engine creates detailed plans that encompass the necessary components, features, technologies, and strategies for your project. It streamlines the process, saving you valuable time and ensuring a comprehensive roadmap for success.",
  },
  {
    question: "Can I customize the generated blueprints?",
    answer:
      "Yes, absolutely! Idea Engine understands that every project is unique, and we provide you with the flexibility to customize the generated blueprints. While our system generates a detailed plan based on the information provided, you have the option to refine, modify, and add specific details according to your preferences. This ensures that the blueprint aligns perfectly with your vision and requirements.",
  },
  {
    question: "Does Idea Engine also help me in executing my vision?",
    answer:
      "Yes, Idea Engine not only helps you in planning and documenting your vision but also provides guidance and resources for executing it. Along with comprehensive blueprints, DayZero offers an AI Library with a repository of tools to enhance implementation. The Expert Network connects you with professionals for specialized expertise and support throughout the execution process. With Idea Engine, you have the tools, resources, and guidance to execute your vision effectively and achieve success.",
  },
  {
    question: 'Is Idea Engine suitable for both startups and established companies?',
    answer: 'Yes, Idea Engine is suitable for both startups and established companies. Whether you are just starting out or have been in business for years, Idea Engine provides a valuable solution for project planning and documentation. It helps startups establish a solid foundation for their ventures and assists established companies in refining their strategies and executing new initiatives.',
  },
  {
    question: 'Is my data secure on the Idea Engine platform?',
