            ...
            <div className='day-algin'>
                {/* <div className="component__ProfileDropdown fix-top-right">
                    <div className="button" data-type="compact">
                        ...
                        <span className="icon" data-active="false">
                    ...
                    <div data-active="false" className="dropdown">
                        <a href="/price">
                            <div className="item">
                ...
                <Link to="/qna-page"><button className='create-btn mt-4'>Create Free Blueprint</button></Link>
