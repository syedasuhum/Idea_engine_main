...
import photo from "../images/product.jpg"
import ThirdPage from "../pages/ThirdPage"
import Pricing from "../pages/Pricing"
import Offering from "../pages/Offering"
import Features from "../pages/Features"
import GlobalSec from "../pages/GlobalSec"
...
export default function HomePage() {
  ...
  return (
    ...
    <div className="bg-overlay">
        ...
        <h1>We are your decision between 
        <br />
        vision & execution
        </h1>
       ...
       <Link to="/signUp"> <button >Get Started</button></Link>
        ...
        <p className='vision' style={{color: 'white'}} >Used by the visionaries, on payroll from</p>
        <p className="spac">(obligatory social proof)</p>
      </div>
      <div className="img-section">
        <img src={photo} className='photo' alt="" />
        <div class="play-icon">
        <svg width="102" height="102" viewBox="0 0 102 102" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M26.4959 87.6566C25.2728 87.6543 24.0713 87.3337 23.0096 86.7263C20.619 85.3716 19.1328 82.7419 19.1328 79.8871V22.1136C19.1328 19.2509 20.619 16.6291 23.0096 15.2745C24.0966 14.6498 25.3313 14.3285 26.5849 14.3443C27.8385 14.3601 29.0648 14.7123 30.1357 15.3641L79.512 44.9202C80.5411 45.5654 81.3894 46.4615 81.9774 47.5243C82.5654 48.587 82.8739 49.7818 82.8739 50.9964C82.8739 52.211 82.5654 53.4057 81.9774 54.4685C81.3894 55.5313 80.5411 56.4273 79.512 57.0725L30.1277 86.6366C29.0318 87.2991 27.7765 87.6517 26.4959 87.6566Z" fill="white" fill-opacity="0.8"></path></svg>
        </div>
      </div>
